...
void Foam::pulseFixedValueFvPatchField<Type>::updateCoeffs()
{
    ...
    // call the function from the parent class fixedValue which will update the coefficients
    fixedValueFvPatchField<Type>::updateCoeffs();
}


// write out the boundary conditions into your field at write time to enable restarting of the simulation
template <class Type>
